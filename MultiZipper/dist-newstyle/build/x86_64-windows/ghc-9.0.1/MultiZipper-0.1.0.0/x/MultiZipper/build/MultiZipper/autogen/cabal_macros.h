...
/* package MultiZipper-0.1.0.0 */
#ifndef VERSION_MultiZipper
#define VERSION_MultiZipper "0.1.0.0"
#endif /* VERSION_MultiZipper */
#ifndef MIN_VERSION_MultiZipper
#define MIN_VERSION_MultiZipper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MultiZipper */
...
#define CURRENT_COMPONENT_ID "MultiZipper-0.1.0.0-inplace-MultiZipper"
