...
/* package MutliZipper-0.1.0.0 */
#ifndef VERSION_MutliZipper
#define VERSION_MutliZipper "0.1.0.0"
#endif /* VERSION_MutliZipper */
#ifndef MIN_VERSION_MutliZipper
#define MIN_VERSION_MutliZipper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MutliZipper */
...
#define CURRENT_COMPONENT_ID "MutliZipper-0.1.0.0-inplace-MutliZipper"
